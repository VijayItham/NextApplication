  ...
  return (
    <>
      <Box className={styles.container}>
        ...
        <Box className={styles.createpincontainer}>
          <Box
            sx={{
          ...
          >
            <ArrowBackIcon
              sx={{ fontSize: "30px", color: "#666666", marginTop: "7px" }}
            />
          </Box>
          ...
          >
            <Typography
              variant="h4"
              component="h3"
              sx={{ color: "#333333", marginBottom: "1rem" }}
            >
              Create Pin?
            </Typography>
            <Typography
            ...
            {error && (
              <Typography
                sx={{ color: "red", fontSize: "14px", marginBottom: "1rem" }}
              >
                {error}
              </Typography>
            )}
