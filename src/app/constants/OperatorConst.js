...
export const column = [
    ...
    { field: 'operatorTypeId', title: 'Operator Type ID', isSortable: true, isResizable: false, sorDirection: 'asc' },
    { field: 'operatorTypeName', title: 'OperatorType Name', isSortable: true, isResizable: false, sorDirection: 'asc' },
